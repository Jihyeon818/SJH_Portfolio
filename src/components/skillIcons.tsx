...
export const skillIcons: SkillItem[] = [
  ...
  // Back-end
  { name: "JAVA", icon: FaJava, color: "#f9f9f9", font: "#1F527F", category: "Back-end" },
  ...
  { name: "Notion", icon: SiNotion, color: "#f9f9f9", font: "#000", category: "Cooperation" },
  ...
  { name: "VSCode", icon: TbBrandVscode , color: "#f9f9f9", font: "#3A5D82", category: "tool" },
];
